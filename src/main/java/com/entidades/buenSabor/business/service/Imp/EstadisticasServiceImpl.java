...
public class EstadisticasServiceImpl implements EstadisticasService {
    ...
    @Override
    public List<IngresosDiarios> ingresosDiarios(LocalDate initialDate, LocalDate endDate) {
        return pedidoRepository.ingresosDiarios(initialDate, endDate);
    }

    @Override
    public List<IngresosMenusales> ingresosMensuales(LocalDate initialDate, LocalDate endDate) {
        return pedidoRepository.ingresosMenusales(initialDate, endDate);
    }

    @Override
    public GananciasNetas findCostosGananciasByFecha(LocalDate initialDate, LocalDate endDate) {
    ...
    @Override
    public byte[] ingresosDiariosExcel(LocalDate fechaDesde, LocalDate fechaHasta) throws IOException {
        Workbook workbook = new HSSFWorkbook();
    ...
    @Override
    public byte[] ingresosMensualesExcel(LocalDate fechaDesde, LocalDate fechaHasta) throws IOException {
        Workbook workbook = new HSSFWorkbook();
    ...
    @Override
    public byte[] gananciasNetasExcel(LocalDate fechaDesde, LocalDate fechaHasta) throws IOException {
        Workbook workbook = new HSSFWorkbook();
    ...
    @Override
    public byte[] cantidadPedidosPorClienteExcel(LocalDate fechaDesde, LocalDate fechaHasta) throws IOException {
        Workbook workbook = new HSSFWorkbook();
